<script>
  ...
  const ModalForm = (() => {
    const MF = {
      ...
      /* -----------------------------------------------------------------------*
       | Runs the Modal Form according to the Method
       * ------------------------------------------------------------------- */
      run: () => {
      ...
      /* -----------------------------------------------------------------------*
       | Methods supported in the Modal Form : create, edit, delete
       * ------------------------------------------------------------------- */
      Method: {
      ...
      /* ---------------------------------------------------------------------------------*
       | Views supported in the Modal Form.
       | Initializes (once) the Modal Id and the Form Id and stores them in View.all
       * ---------------------------------------------------------------------------- */
      View: {
